...
SECRET_KEY = 'xz87_tjpi9%6@f%$=$=&y$n_#=9b9q_iz+cf&u+(iyf!nq*^md'
...
#STATIC_ROOT = "/home/priya/myproject/PasswordSaver/static"
...
#    os.path.join(BASE_DIR, "static"),
    os.path.join(BASE_DIR, "static/PasswordSaver/"), # this is for static/django-ajax-search/main.css
)
